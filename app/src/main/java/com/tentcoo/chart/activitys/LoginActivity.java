...
import com.tentcoo.chart.controller.LoginController;
import com.tentcoo.chart.utils.BitmapLoader;
import com.tentcoo.chart.utils.SharePreferenceManager;
import com.tentcoo.chart.view.ClearWriteEditText;
import com.tentcoo.chart.view.SoftKeyBoardStateHelper;
     ...
     /*   mRadioGroup = (RadioGroup) findViewById(R.id.rg_group);
       ...
       /* if (!isTestVisibility) {
        ...
        if (bitmap != null) {
            ...
            mDe_login_logo.setImageResource(R.drawable.jmui_head_icon);
        }
